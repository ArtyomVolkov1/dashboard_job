...
const HomeCard = ({ title, description, count }: HomeCardProp) => {
  return (
    <article className="flex items-center justify-between rounded-lg border border-gray-100 bg-white p-6 hover:scale-105 shadow-md">
      <div>
  ...
  <div class="p-4 xl:ml-80">
    ...
    <div class="mt-12">
      <div class="mb-12 grid gap-y-10 gap-x-6 md:grid-cols-2 xl:grid-cols-4">
        <div class="relative flex flex-col items-center bg-clip-border rounded-xl bg-white text-gray-700 shadow-md">
        ...
        <div class="relative flex justify-center  bg-clip-border rounded-xl bg-white text-gray-700 shadow-md overflow-hidden xl:col-span-2">
          <div class="relative bg-clip-border rounded-xl overflow-hidden bg-transparent text-gray-700 shadow-none m-0 flex items-center justify-between p-6">
            <div>
              <h6 class="block antialiased tracking-normal font-sans text-base font-semibold leading-relaxed text-blue-gray-900 mb-1">Проектов</h6>
              <p class="antialiased font-sans text-sm leading-normal flex items-center gap-1 font-normal text-blue-gray-600">
                ...
                <strong>30 выполнено</strong> в этом месяце
              </p>
            </div>
          </div>
        </div>
